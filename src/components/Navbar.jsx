...
export default function Navbar({toggleCartVisibility}){
    ...
    return(
        <div className="navbar bg-white text-black w-full underline-nav">
        <div className="navbar-start">
            <div className="ms-5">
            <img src={logo} alt="Flavor Express" className='w-40'/>
            </div>
        </div>
        <div className="navbar-center hidden lg:flex md:flex">
          <ul className="menu menu-horizontal text-lg xl:gap-32 md:gap-24">
              <li>item 1</li>
              <li>item 2</li>
              <li>item 3</li>
          </ul>
